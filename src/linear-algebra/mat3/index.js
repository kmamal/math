...
const makeMatrix = (Domain) => {
	...
	const isFinite = ([ m11, m21, m31, m12, m22, m32, m13, m23, m33 ]) => true
		&& _isFinite(m11)
		&& _isFinite(m21)
		&& _isFinite(m31)
		&& _isFinite(m12)
	...
	const isNaN = ([ m11, m21, m31, m12, m22, m32, m13, m23, m33 ]) => false
		|| _isNaN(m11)
		|| _isNaN(m21)
		|| _isNaN(m31)
		|| _isNaN(m12)
	...
	const neg = ([ m11, m21, m31, m12, m22, m32, m13, m23, m33 ]) => [
		_neg(m11),
		_neg(m21),
		_neg(m31),
		_neg(m12),
	...
	const add$$$ = (a, [ b11, b21, b31, b12, b22, b32, b13, b23, b33 ]) => {
	...
	const sub$$$ = (a, [ b11, b21, b31, b12, b22, b32, b13, b23, b33 ]) => {
		const [ a11, a21, a31, a12, a22, a32, a13, a23, a33 ] = a
		a[M11] = _sub(a11, b11)
		a[M21] = _sub(a21, b21)
		a[M31] = _sub(a31, b31)
	...
	const mul$$$ = (a, [ b11, b21, b31, b12, b22, b32, b13, b23, b33 ]) => {
		const [ a11, a21, a31, a12, a22, a32, a13, a23, a33 ] = a
	...
	const transpose = ([ m11, m21, m31, m12, m22, m32, m13, m23, m33 ]) => [
		m11,
		m12,
		m13,
		m21,
	...
	const scale = ([ m11, m21, m31, m12, m22, m32, m13, m23, m33 ], v) => [
		_mul(m11, v),
		_mul(m21, v),
		_mul(m31, v),
		_mul(m12, v),
