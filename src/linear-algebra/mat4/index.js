...
const makeMatrix = (Domain) => {
	...
	const isFinite = ([ m11, m21, m31, m41, m12, m22, m32, m42, m13, m23, m33, m43, m14, m24, m34, m44 ]) => true
		&& _isFinite(m11)
		&& _isFinite(m21)
		&& _isFinite(m31)
		&& _isFinite(m41)
	...
	const isNaN = ([ m11, m21, m31, m41, m12, m22, m32, m42, m13, m23, m33, m43, m14, m24, m34, m44 ]) => false
		|| _isNaN(m11)
		|| _isNaN(m21)
		|| _isNaN(m31)
		|| _isNaN(m41)
	...
	const neg = ([ m11, m21, m31, m41, m12, m22, m32, m42, m13, m23, m33, m43, m14, m24, m34, m44 ]) => [
		_neg(m11),
		_neg(m21),
		_neg(m31),
		_neg(m41),
	...
	const neg$$$ = (m) => {
		const [ m11, m21, m31, m41, m12, m22, m32, m42, m13, m23, m33, m43, m14, m24, m34, m44 ] = m
		m[M11] = _neg(m11)
		m[M21] = _neg(m21)
		m[M31] = _neg(m31)
		m[M41] = _neg(m41)
	...
	const add$$$ = (a, [ b11, b21, b31, b41, b12, b22, b32, b42, b13, b23, b33, b43, b14, b24, b34, b44 ]) => {
	...
	const sub$$$ = (a, [ b11, b21, b31, b41, b12, b22, b32, b42, b13, b23, b33, b43, b14, b24, b34, b44 ]) => {
		const [ a11, a21, a31, a41, a12, a22, a32, a42, a13, a23, a33, a43, a14, a24, a34, a44 ] = a
		a[M11] = _sub(a11, b11)
		a[M21] = _sub(a21, b21)
		a[M31] = _sub(a31, b31)
	...
	const mul$$$ = (a, [ b11, b21, b31, b41, b12, b22, b32, b42, b13, b23, b33, b43, b14, b24, b34, b44 ]) => {
		const [ a11, a21, a31, a41, a12, a22, a32, a42, a13, a23, a33, a43, a14, a24, a34, a44 ] = a
	...
	const transpose = ([ m11, m21, m31, m41, m12, m22, m32, m42, m13, m23, m33, m43, m14, m24, m34, m44 ]) => [
		m11,
		m12,
		m13,
		m14,
	...
	const scale = ([ m11, m21, m31, m41, m12, m22, m32, m42, m13, m23, m33, m43, m14, m24, m34, m44 ], v) => [
		_mul(m11, v),
		_mul(m21, v),
		_mul(m31, v),
		_mul(m41, v),
