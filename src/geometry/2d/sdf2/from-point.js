...
const defineFor = memoize((Domain) => {
	...
	const point2pointSquared = (a, { translation }, b) => V2.normSquared(translation)

	const point2point = (a, transform, b) => sqrt(point2pointSquared(transform))

	const point2circle = (a, { translation }, { r }) => V2.norm(translation) - r
